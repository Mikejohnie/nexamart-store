...
const LoginForm = () => {
  ...
  return (
    <div>
      <main className="relative min-h-screen flex items-center justify-center bg-gray-300 px-4">
        ...
        <div className="w-full max-w-md bg-teal-50 p-8 rounded-2xl shadow-md">
